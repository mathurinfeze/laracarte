...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="alert alert-warning">
                    <strong><i class="fas fa-exclamation-triangle" ></i> This map has been built @etsmo for learning purposes</strong>
                </p>
            </div>
        </div>
        ...
        <hr>
        <h2>Which toold andservicesare used in laracarte?</h2>
